...
const SetQuestionAutomated = () => {
  ...
  const handleManualEntry = (test) => {
    navigate("/automate-entry", {
      state: {
        TestId: test.test_id,
              ...
              Test.map((test, index) => (
                <TableRow key={index}>
                  ...
                  <DoneIcon
                    ...
                    onClick={() => handleManualEntry(test)}
                  />
                </TableCell>
                </TableRow>
              ))
...
export default SetQuestionAutomated;
